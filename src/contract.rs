...
//     let errors1  = "asdasd";
//     let state = config_read(deps.storage).load()?;
//     let example_private_key: [u8; 32] = [
//         0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
//         0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
//         0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
//         0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
//     ];
//     let private_key = match PrivateKey::parse(&example_private_key) {
//         Ok(pr) => pr,
//         Err(E) =>  return Ok(CountResponse { count: errors , sign: errors1.to_string()})
//     };
...
//     Ok(CountResponse { count: state.count, sign: hex::encode(signature.serialize())})
// }
